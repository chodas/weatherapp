package com.example.weatherapp.myapplication.adapters;
...
import com.example.weatherapp.myapplication.activities.MainActivity;
...
import com.example.weatherapp.myapplication.utils.IconProvider;
...
public class CityWeatherAdapter extends RecyclerView.Adapter<CityWeatherAdapter.ViewHolder> implements onSwipeListener {
    ...
    public void onItemDelete(final int position) {
        ...
        Snackbar.make(parentView, "Usuń", Snackbar.LENGTH_LONG)
                .setAction("Dodaj", v -> {
