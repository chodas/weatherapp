package com.example.weatherapp.myapplication.activities;
...
import com.example.weatherapp.myapplication.API.API;
import com.example.weatherapp.myapplication.API.APIServices.WeatherServices;
import com.example.weatherapp.myapplication.R;
import com.example.weatherapp.myapplication.adapters.CityWeatherAdapter;
import com.example.weatherapp.myapplication.interfaces.onSwipeListener;
import com.example.weatherapp.myapplication.models.CityWeather;
import com.example.weatherapp.myapplication.utils.ItemTouchHelperCallback;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void showFabPrompt()
    {
        ...
        mFabPrompt = new MaterialTapTargetPrompt.Builder(MainActivity.this)
                ...
                .setPrimaryText("Dodaj swoje pierwsze miasto")
                .setSecondaryText("Wciśnij klawisz aby dodać miasto!")
                ...
                .setPromptStateChangeListener((prompt, state) -> {
                    ...
                    {
                        mFabPrompt = null;
                      //robi coś z zawartościa i pozniej nie wraca hah !
                    }
                })
                .create();
        mFabPrompt.show();
        ...
        cityWeather.enqueue(new Callback<CityWeather>() {
            ...
            public void onResponse(Call<CityWeather> call, Response<CityWeather> response) {
                if(response.code()==200){
                    ...
                    Toast.makeText(MainActivity.this,"Przepraszam, nie znalazłam miasta",Toast.LENGTH_LONG).show();
                }
            }
            @Override
            public void onFailure(Call<CityWeather> call, Throwable t) {
                Toast.makeText(MainActivity.this,"Przepraszam, pogodynka jest nie dostępna",Toast.LENGTH_LONG).show();
            }
        });
    }
